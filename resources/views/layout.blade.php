...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.0.0/sweetalert.css" integrity="sha512-89dj20t0ePIY5LVWjdFJwXKHq326wykdMXRvJ0IApshtw79sL5IURuvU5A3w/fwKW5pUZlwMer12Gg2MA/pvng==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    {{--  <!--[if lt IE 9]>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="{{ ('frontend/images/home/girl11.png') }}" class="girl img-responsive" alt="" />
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{ ('frontend/images/home/girl12.png') }}" class="girl img-responsive" alt="" />
									<img src="{{ ('frontend/images/home/pricing.png') }}"  class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="{{ ('frontend/images/home/girl13.png') }}" class="girl img-responsive" alt="" />
									<img src="{{ ('frontend/images/home/pricing.png') }}" class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="brands-name">
                                @foreach ($brand as $brand )
                                    <ul class="nav nav-pills nav-stacked">
                                        <li><a href="{{URL::to('danh-muc-thuong-hieu/'.$brand->brand_id)}}"> <span class="pull-right"></span>{{ $brand -> brand_name }}</a></li>
                                    </ul>
                                @endforeach
